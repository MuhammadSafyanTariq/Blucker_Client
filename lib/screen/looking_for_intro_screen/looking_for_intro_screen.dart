...
import 'package:blukers_client_app/screen/looking_for_intro_screen/looking_for_intro_widget/looking_for_intro_widget.dart';
import 'package:blukers_client_app/screen/looking_for_intro_screen/looking_for_you_intro_screen_controller.dart';
import 'package:blukers_client_app/utils/app_style.dart';
import 'package:blukers_client_app/utils/asset_res.dart';
import 'package:blukers_client_app/utils/color_res.dart';
import 'package:blukers_client_app/utils/string.dart';

class LookingForIntroScreen extends StatelessWidget {
  const LookingForIntroScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(LookingForYouIntroScreenController());
    return Scaffold(
      // appBar: AppBar(
