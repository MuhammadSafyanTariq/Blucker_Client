class AssetRes {
  ...
  static const del = "${icons}delete1.png";
  ...
  static const facebookImage = '${images}facebook_image.png';
  static const googleLogo = '${images}Google_logo.png';
  ...
  static const page1 = "${images}page1.png";
